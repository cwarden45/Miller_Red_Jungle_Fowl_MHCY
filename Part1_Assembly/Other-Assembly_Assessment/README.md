...
We encountered a problem when running Pilon on the most recent version of the assembly, as described [here](https://github.com/broadinstitute/pilon/issues/136).  So, a count that we believe is relatively more accurate is provided in the 2nd table on the [main subfolder](https://github.com/cwarden45/Miller_Red_Jungle_Fowl_MHCY/tree/main/Part1_Assembly), but we unfortuantely do not provide a detailed list for the most recent assembly.
