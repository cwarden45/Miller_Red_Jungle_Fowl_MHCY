#setwd("R:\\mmiller\\Seq\\BAC_annotation\\Code\\190M\\revise_Canu_v1_5")

sampleID = "190M"
yellow_thresh=88
red_thresh=50
FQ_in="Canu-v1.5-Arrow_190M-rearranged--extra_12bp-expectedBAC/arrow_consensus.fastq"
output.image="Canu-v1.5-Arrow_190M-rearranged--extra_12bp-expectedBAC/arrow_consensus-qual.png"
output.text="Canu-v1.5-Arrow_190M-rearranged--extra_12bp-expectedBAC/arrow_consensus-qual.txt"
