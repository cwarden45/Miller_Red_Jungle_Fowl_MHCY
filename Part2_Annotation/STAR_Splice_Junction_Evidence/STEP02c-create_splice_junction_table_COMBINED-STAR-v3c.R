...
combined_totalCPM = "combined_splice_junctions-STAR-v4_totalCPM-param9-ADJUSTED.txt"
sample_densityQC = "combined_splice_junctions-STAR-v4_totalCPM-ADJUSTED-sample_density-param9.png"
junction_average_density = "combined_splice_junctions-STAR-v4_totalCPM-ADJUSTED-junction_average_density-param9.txt"
junction_average_densityQC = "combined_splice_junctions-STAR-v4_totalCPM-ADJUSTED-junction_average_density-param9.png"
...
Gender2 = rep("F",nrow(sample_info))
Gender2[sample_info$Gender == "male"]="M"
altID = paste(sample_info$Sample,Gender2,sample_info$Tissue,sep=".")
...
totalCPM.table = read.table(combined_totalCPM, head=T, sep="\t")
