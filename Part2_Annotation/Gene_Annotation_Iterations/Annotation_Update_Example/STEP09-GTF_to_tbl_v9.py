...
tbl = contig+"_BLAST_annotated_gene_v12.tbl"
...
while line:
	...
	if gene1 in contig1hash:
		...
		if not gene2Result:
			contig1hash[gene1] = contig1hash[gene1] + " , " + percentIdentity + "% identity to " + gene2 + " for " +hitLength+  " bp"
	else:
		contig1hash[gene1] = percentIdentity + "% identity to " + gene2 + " for " +hitLength+  " bp"
	...
	if gene2 in contig1hash:
		...
		if not gene1Result:
			contig1hash[gene2] = contig1hash[gene2] + " , " + percentIdentity + "% identity to " + gene1 + " for " +hitLength+  " bp"
	else:
		contig1hash[gene2] = percentIdentity + "% identity to " + gene1 + " for " +hitLength+  " bp"
...
while line:
	...
	if gene1 in contig2hash:
		...
		if not gene2Result:
			contig2hash[gene1] = contig2hash[gene1] + " , " + percentIdentity + "% identity to " + gene2 + " for " +hitLength+  " bp"
	else:
		contig2hash[gene1] = percentIdentity + "% identity to " + gene2 + " for " +hitLength+  " bp"
		
	#add extra mappings so that duplicates on Contig1 can also be noted
	if gene2 in contig2hash:
		gene1Result = re.search(gene1, contig2hash[gene2])
		if not gene1Result:
			contig2hash[gene2] = contig2hash[gene2] + " , " + percentIdentity + "% identity to " + gene1 + " for " +hitLength+  " bp"
	else:
		contig2hash[gene2] = percentIdentity + "% identity to " + gene1 + " for " +hitLength+  " bp"
...
while line:
	...
	if gene1 in contig3hash:
		...
		if not gene2Result:
			contig3hash[gene1] = contig3hash[gene1] + " , " + percentIdentity + "% identity to " + gene2 + " for " +hitLength+  " bp"
	else:
		contig3hash[gene1] = percentIdentity + "% identity to " + gene2 + " for " +hitLength+  " bp"
		
	#add extra mappings so that duplicates on Contig1 can also be noted
	if gene2 in contig3hash:
		gene1Result = re.search(gene1, contig3hash[gene2])
		if not gene1Result:
			contig3hash[gene2] = contig3hash[gene2] + " , " + percentIdentity + "% identity to " + gene1 + " for " +hitLength+  " bp"
	else:
		contig3hash[gene2] = percentIdentity + "% identity to " + gene1 + " for " +hitLength+  " bp"
...
while line:
	...
	if gene1 in contig4hash:
		...
		if not gene2Result:
			contig4hash[gene1] = contig4hash[gene1] + " , " + percentIdentity + "% identity to " + gene2 + " for " +hitLength+  " bp"
	else:
		contig4hash[gene1] = percentIdentity + "% identity to " + gene2 + " for " +hitLength+  " bp"
		
	#add extra mappings so that duplicates on Contig1 can also be noted
	if gene2 in contig4hash:
		gene1Result = re.search(gene1, contig4hash[gene2])
		if not gene1Result:
			contig4hash[gene2] = contig4hash[gene2] + " , " + percentIdentity + "% identity to " + gene1 + " for " +hitLength+  " bp"
	else:
		contig4hash[gene2] = percentIdentity + "% identity to " + gene1 + " for " +hitLength+  " bp"
		...
		if (type != "rRNA"):
			if previous_gene == "":
				...
				if refseqHomology == "NA":
					...
					if refseqHomology != "Homology to RefSeq Predicted Genes":
