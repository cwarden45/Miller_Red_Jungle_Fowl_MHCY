...
#LOC_count = 0
#pileupGTF = "../../BAC_annotation/latest_sequin_files-G3_submission/Contig3_34j16_rev/Intermediate_Files/Contig3_updated_genes_220824.gtf"
#prev_YLec = 29
#prev_YF = 33
#prev_LENG = 5
#prev_ZNF = 2
	...
	if type != "misc_RNA":
		...
		if (previous_gene != "") and (previous_gene != gene_type):	
			...
			if yfaResult:
				...
				previous_ID = "RJF."+contig+".LOC" + locNum + "." + previous_gene
				description = "Only Zinc Finger-like, Gene 1"
				print "-->ID:"+previous_ID
			elif znfResult:
				prev_ZNF +=1
		...
		if rRNA_result:
			...
			if result18:
				LOC_count += 1
				description = "18S ribosomal RNA (rRNA)"
			elif result5:
				description = "5.8S ribosomal RNA (rRNA)"
			elif result28:
				description = "28S ribosomal RNA (rRNA)"
				rRNA_count -= 1
			else:
