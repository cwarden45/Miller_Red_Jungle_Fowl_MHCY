...
However, the code for the most recent update can be used to try and help explain how the annotations were updated for downstream analysis (including creation of part of *Figure 1*).
...
You must have already run the code to summarize [STAR splice junctions]() before this table can be created.
