compID = "1o23_revision"
yname = "Canu v2.1 (revised)"
ymax = 102743
xname = "1o23"
xmax = 77997
backbone1 = c(1445, 12129)
backbone2 = c(90055, 100739)
...
plot(0, 0, axes=FALSE, ylim=c(0,plot.max), xlim=c(0,plot.max),
				ylab="", xlab="", main="Revised vs Early Assembly", cex.main=1.5)
...
rect(0,backbone2[1],xmax,backbone2[2],col=rgb(0.2, 0.2, 0.2, alpha = 0.2))
