...
#SBATCH --output=BQA190n5k10.log

UNALIGNED=../../Intermediate_Files/160505_B2_58f18.subreads.bam #there was a sample swap
INPUTASSEMBLY=Canu-v1.5-Arrow_190M-rearranged-extra_12bp-expectedBAC.fa
PREFIX=Canu-v1.5-Arrow_190M-rearranged--extra_12bp-expectedBAC
