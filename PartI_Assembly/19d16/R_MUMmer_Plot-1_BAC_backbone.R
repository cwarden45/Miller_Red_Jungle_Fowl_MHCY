compID = "19d16_revision"
yname = "HGAP3 (early)"
ymax = 193267
xname = "HGAP3 Re-Arranged (+ Arrow)"
xmax = 158945
backbone1 = c(37062,44574)
...
for (i in 1:forward.pair.count){
	...
	points(c(start.row[1],stop.row[1]),c(start.row[2],stop.row[2]), col="red", pch=19, cex=1)
